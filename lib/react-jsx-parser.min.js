...
if(-1===t.blacklistedTags.indexOf(v.trim().toLowerCase())){var g=void 0
if(p[v]||(0,y.canHaveChildren)(v))if(g=u.map(t.parseExpression),p[v]||(0,y.canHaveWhitespace)(v)||(g=g.filter(function(t){return"string"!=typeof t||!/^\s*$/.test(t)})),0===g.length)g=void 0
else if(1===g.length){var b=g,k=h(b,1)
g=k[0]}var E=o({key:s},n)
return m.forEach(function(e){var s=e.name.name,i=x.default[s]||s,r=t.parseExpression(e)
0===t.blacklistedAttrs.filter(function(t){return t.test(i)}).length&&(E[i]=r)}),"string"==typeof E.style&&(E.style=(0,f.default)(E.style)),l.default.createElement(p[v]||v,E,g)}},this.render=function(){return t.props.renderInWrapper?l.default.createElement("div",{className:"jsx-parser"},t.ParsedChildren):t.ParsedChildren}}
