...
throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),h=s(1),p=s(5),c=i(p),u=s(6),l=i(u),d=s(8),f=s(9),m=i(f),x=s(10),y={plugins:{jsx:!0}},v=function(t){function e(){var t,s,i,a
r(this,e)
for(var u=arguments.length,f=Array(u),v=0;v<u;v++)f[v]=arguments[v]
return s=i=n(this,(t=e.__proto__||Object.getPrototypeOf(e)).call.apply(t,[this].concat(f))),i.parseJSX=function(t){var e="<root>"+t+"</root>",s=[]
try{s=new h.Parser(y,e).parse(),s=s.body[0].expression.children||[]}catch(t){return i.props.showWarnings&&console.warn(t),i.props.onError&&i.props.onError(t),[]}return s.map(i.parseExpression).filter(Boolean)},i.parseExpression=function(t){switch(t.type){case"JSXElement":return i.parseElement(t)
case"JSXText":return c.default.createElement(p.Fragment,{key:(0,d.randomHash)()},t.value||"")
case"JSXAttribute":return null===t.value||i.parseExpression(t.value)
case"ArrayExpression":return t.elements.map(i.parseExpression)
case"ObjectExpression":var e={}
return t.properties.forEach(function(t){e[t.key.name||t.key.value]=i.parseExpression(t.value)}),e
case"Identifier":return(i.props.bindings||{})[t.name]
case"JSXExpressionContainer":return i.parseExpression(t.expression)
case"Literal":return t.value
case"MemberExpression":return(i.parseExpression(t.object)||{})[t.property.name]
case"CallExpression":return i.parseExpression(t.callee)
case"LogicalExpression":var s=i.parseExpression(t.left)
return!("||"!==t.operator||!s)||!!("&&"===t.operator&&s||"||"===t.operator&&!s)&&i.parseExpression(t.right)
default:return}},i.parseElement=function(t){var e=i.props,s=e.components,r=void 0===s?{}:s,n=e.componentsOnly,a=t.children,h=void 0===a?[]:a,p=t.openingElement,u=p.attributes,f=void 0===u?[]:u,y=p.name
y=void 0===y?{}:y
var v=y.name,g=(i.props.blacklistedAttrs||[]).map(function(t){return t instanceof RegExp?t:new RegExp(t,"i")}),b=(i.props.blacklistedTags||[]).map(function(t){return t.trim().toLowerCase()}).filter(Boolean)
if(/^(html|head|body)$/i.test(v))return h.map(function(t){return i.parseElement(t)})
if(-1===b.indexOf(v.trim().toLowerCase())&&(!n||r[v])){var k=void 0
if(r[v]||(0,x.canHaveChildren)(v))if(k=h.map(i.parseExpression),r[v]||(0,x.canHaveWhitespace)(v)||(k=k.filter(function(t){return"string"!=typeof t||!/^\s*$/.test(t)})),0===k.length)k=void 0
else if(1===k.length){var E=k,w=o(E,1)
k=w[0]}var A={key:(0,d.randomHash)()}
return f.forEach(function(t){var e=t.name.name,s=m.default[e]||e,r=i.parseExpression(t)
0===g.filter(function(t){return t.test(s)}).length&&(A[s]=r)}),"string"==typeof A.style&&(A.style=(0,l.default)(A.style)),k&&(A.children=k),c.default.createElement(r[v]||v.toLowerCase(),A)}},i.render=function(){var t=(i.props.jsx||"").trim().replace(/<!DOCTYPE([^>]*)>/g,"")
return i.ParsedChildren=i.parseJSX(t),i.props.renderInWrapper?c.default.createElement("div",{className:"jsx-parser"},i.ParsedChildren):c.default.createElement(p.Fragment,null,i.ParsedChildren)},a=s,n(i,a)}return a(e,t),e}(p.Component)
v.defaultProps={bindings:{},blacklistedAttrs:[/^on.+/i],blacklistedTags:["script"],components:[],componentsOnly:!1,jsx:"",onError:function(){},showWarnings:!1,renderInWrapper:!0},v.displayName="JsxParser",e.default=v},function(t,e,s){"use strict"
