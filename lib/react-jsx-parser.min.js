...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,s,i){return s&&t(e.prototype,s),i&&t(e,i),e}}(),p=s(1),c=s(5),l=i(c),u=s(6),d=i(u),f=s(8),m=i(f),x=s(9),y={plugins:{jsx:!0}},v=function(t){function e(t){r(this,e)
...
try{s=new p.Parser(y,e).parse(),s=s.body[0].expression.children||[]}catch(t){return this.props.showWarnings&&console.warn(t),[]}return s.map(this.parseExpression).filter(Boolean)}},{key:"parseExpression",value:function(t,e){var s=this,i=t.value
...
if(-1===this.blacklistedTags.indexOf(y.trim().toLowerCase())){var v=void 0;(0,x.canHaveChildren)(y)&&(v=c.map(this.parseExpression),(0,x.canHaveWhitespace)(y)||(v=v.filter(function(t){return"string"!=typeof t||!/^\s*$/.test(t)})))
var b=o({key:e},n)
...
e.default=v,v.defaultProps={bindings:{},blacklistedAttrs:[/^on.+/i],blacklistedTags:["script"],components:[],jsx:"",showWarnings:!1}},function(t,e,s){"use strict"
