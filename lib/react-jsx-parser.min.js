...
for(var i in s)Object.prototype.hasOwnProperty.call(s,i)&&(t[i]=s[i])}return t},h=function(){function t(t,e){for(var s=0;s<e.length;s++){var i=e[s]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,s,i){return s&&t(e.prototype,s),i&&t(e,i),e}}(),p=s(1),c=s(5),u=i(c),l=s(6),d=i(l),f=s(8),m=i(f),x=s(9),y={plugins:{jsx:!0}},v=function(t){function e(t){r(this,e)
var s=n(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t))
return s.parseElement=s.parseElement.bind(s),s.parseExpression=s.parseExpression.bind(s),s.parseJSX=s.parseJSX.bind(s),s.handleNewProps=s.handleNewProps.bind(s),s.handleNewProps(t),s}return a(e,t),h(e,[{key:"componentWillReceiveProps",value:function(t){this.handleNewProps(t)}},{key:"handleNewProps",value:function(t){this.blacklistedTags=(t.blacklistedTags||[]).map(function(t){return t.trim().toLowerCase()}).filter(Boolean),this.blacklistedAttrs=(t.blacklistedAttrs||[]).map(function(t){return t instanceof RegExp?t:new RegExp(t,"i")})
var e=(t.jsx||"").trim().replace(/<!DOCTYPE([^>]*)>/g,"")
this.ParsedChildren=this.parseJSX(e)}},{key:"parseJSX",value:function(t){var e="<root>"+t+"</root>",s=[]
...
var r=F.exec(t)
if(!(r&&r.index<e))return new z(s,e-i);++s,i=r.index+r[0].length}}function u(t){var e={}
for(var s in W)e[s]=t&&p(t,s)?t[s]:W[s]
if(e.ecmaVersion>=2015&&(e.ecmaVersion-=2009),null==e.allowReserved&&(e.allowReserved=e.ecmaVersion<5),U(e.onToken)){var i=e.onToken
...
var Q=$.prototype
Q.parseTopLevel=function(t){var e=this,s={}
...
else{if(t.declaration=null,t.specifiers=this.parseExportSpecifiers(e),this.eatContextual("from"))t.source=this.type===O.string?this.parseExprAtom():this.unexpected()
else{for(var a=0,o=t.specifiers;a<o.length;a+=1){var h=o[a]
s.checkUnreserved(h.local)}t.source=null}this.semicolon()}return this.finishNode(t,"ExportNamedDeclaration")},Q.checkExport=function(t,e,s){t&&(p(t,e)&&this.raiseRecoverable(s,"Duplicate export '"+e+"'"),t[e]=!0)},Q.checkPatternExport=function(t,e){var s=this,i=e.type
...
p&&s.checkPatternExport(t,p)}else"AssignmentPattern"==i?this.checkPatternExport(t,e.left):"ParenthesizedExpression"==i&&this.checkPatternExport(t,e.expression)},Q.checkVariableExport=function(t,e){var s=this
if(t)for(var i=0,r=e;i<r.length;i+=1){var n=r[i]
s.checkPatternExport(t,n.id)}},Q.shouldParseExportStatement=function(){return"var"===this.type.keyword||"const"===this.type.keyword||"class"===this.type.keyword||"function"===this.type.keyword||this.isLet()||this.isAsyncFunction()},Q.parseExportSpecifiers=function(t){var e=this,s=[],i=!0
for(this.expect(O.braceL);!this.eat(O.braceR);){if(i)i=!1
else if(e.expect(O.comma),e.afterTrailingComma(O.braceR))break
var r=e.startNode()
r.local=e.parseIdent(!0),r.exported=e.eatContextual("as")?e.parseIdent(!0):r.local,e.checkExport(t,r.exported.name,r.exported.start),s.push(e.finishNode(r,"ExportSpecifier"))}return s},Q.parseImport=function(t){return this.next(),this.type===O.string?(t.specifiers=tt,t.source=this.parseExprAtom()):(t.specifiers=this.parseImportSpecifiers(),this.expectContextual("from"),t.source=this.type===O.string?this.parseExprAtom():this.unexpected()),this.semicolon(),this.finishNode(t,"ImportDeclaration")},Q.parseImportSpecifiers=function(){var t=this,e=[],s=!0
...
var n=t.startNode()
n.imported=t.parseIdent(!0),t.eatContextual("as")?n.local=t.parseIdent():(t.checkUnreserved(n.imported),n.local=n.imported),t.checkLVal(n.local,"let"),e.push(t.finishNode(n,"ImportSpecifier"))}return e},Q.adaptDirectivePrologue=function(t){for(var e=0;e<t.length&&this.isDirectiveCandidate(t[e]);++e)t[e].directive=t[e].expression.raw.slice(1,-1)},Q.isDirectiveCandidate=function(t){return"ExpressionStatement"===t.type&&"Literal"===t.expression.type&&"string"==typeof t.expression.value&&('"'===this.input[t.start]||"'"===this.input[t.start])}
var et=$.prototype
et.toAssignable=function(t,e){var s=this
...
for(var i=0,r=t.properties;i<r.length;i+=1){var n=r[i]
"init"!==n.kind&&s.raise(n.key.start,"Object pattern can't contain getter or setter"),s.toAssignable(n.value,e)}break
...
default:this.raise(t.start,"Assigning to rvalue")}return t},et.toAssignableList=function(t,e){var s=this,i=t.length
if(i){var r=t[i-1]
if(r&&"RestElement"==r.type)--i
else if(r&&"SpreadElement"==r.type){r.type="RestElement"
var n=r.argument
this.toAssignable(n,e),--i}6===this.options.ecmaVersion&&e&&r&&"RestElement"===r.type&&"Identifier"!==r.argument.type&&this.unexpected(r.argument.start)}for(var a=0;a<i;a++){var o=t[a]
o&&s.toAssignable(o,e)}return t},et.parseSpread=function(t){var e=this.startNode()
return this.next(),e.argument=this.parseMaybeAssign(!1,t),this.finishNode(e,"SpreadElement")},et.parseRestBinding=function(){var t=this.startNode()
return this.next(),6===this.options.ecmaVersion&&this.type!==O.name&&this.unexpected(),t.argument=this.parseBindingAtom(),this.finishNode(t,"RestElement")},et.parseBindingAtom=function(){if(this.options.ecmaVersion>=6)switch(this.type){case O.bracketL:var t=this.startNode()
...
var a=this.labels
this.labels=[],r&&(this.strict=!0),this.checkParams(t,!i&&!r&&!e&&this.isSimpleParamList(t.params)),t.body=this.parseBlock(!1),t.expression=!1,this.adaptDirectivePrologue(t.body.body),this.labels=a}this.exitFunctionScope(),this.strict&&t.id&&this.checkLVal(t.id,"none"),this.strict=i},st.isSimpleParamList=function(t){for(var e=0,s=t;e<s.length;e+=1){if("Identifier"!==s[e].type)return!1}return!0},st.checkParams=function(t,e){for(var s=this,i={},r=0,n=t.params;r<n.length;r+=1){var a=n[r]
s.checkLVal(a,"var",e?null:i)}},st.parseExprList=function(t,e,s,i){for(var r=this,n=[],a=!0;!this.eat(t);){if(a)a=!1
else if(r.expect(O.comma),e&&r.afterTrailingComma(t))break
var o=void 0
s&&r.type===O.comma?o=null:r.type===O.ellipsis?(o=r.parseSpread(i),i&&r.type===O.comma&&i.trailingComma<0&&(i.trailingComma=r.start)):o=r.parseMaybeAssign(!1,i),n.push(o)}return n},st.checkUnreserved=function(t){var e=t.start,s=t.end,i=t.name
if(this.inGenerator&&"yield"===i&&this.raiseRecoverable(e,"Can not use 'yield' as identifier inside a generator"),this.inAsync&&"await"===i&&this.raiseRecoverable(e,"Can not use 'await' as identifier inside an async function"),this.isKeyword(i)&&this.raise(e,"Unexpected keyword '"+i+"'"),!(this.options.ecmaVersion<6&&-1!=this.input.slice(e,s).indexOf("\\"))){(this.strict?this.reservedWordsStrict:this.reservedWords).test(i)&&this.raiseRecoverable(e,"The keyword '"+i+"' is reserved")}},st.parseIdent=function(t,e){var s=this.startNode()
return t&&"never"==this.options.allowReserved&&(t=!1),this.type===O.name?s.name=this.value:this.type.keyword?(s.name=this.type.keyword,"class"!==s.name&&"function"!==s.name||this.lastTokEnd===this.lastTokStart+1&&46===this.input.charCodeAt(this.lastTokStart)||this.context.pop()):this.unexpected(),this.next(),this.finishNode(s,"Identifier"),t||this.checkUnreserved(s),s},st.parseYield=function(){this.yieldPos||(this.yieldPos=this.start)
var t=this.startNode()
return this.next(),this.type==O.semi||this.canInsertSemicolon()||this.type!=O.star&&!this.type.startsExpr?(t.delegate=!1,t.argument=null):(t.delegate=this.eat(O.star),t.argument=this.parseMaybeAssign()),this.finishNode(t,"YieldExpression")},st.parseAwait=function(){this.awaitPos||(this.awaitPos=this.start)
var t=this.startNode()
return this.next(),t.argument=this.parseMaybeUnary(null,!0),this.finishNode(t,"AwaitExpression")}
var rt=$.prototype
rt.raise=function(t,e){var s=c(this.input,t)
e+=" ("+s.line+":"+s.column+")"
...
nt.enterFunctionScope=function(){this.scopeStack.push({var:{},lexical:{},childVar:{},parentLexical:{}})},nt.exitFunctionScope=function(){this.scopeStack.pop()},nt.enterLexicalScope=function(){var t=this.scopeStack[this.scopeStack.length-1],e={var:{},lexical:{},childVar:{},parentLexical:{}}
this.scopeStack.push(e),at(e.parentLexical,t.lexical,t.parentLexical)},nt.exitLexicalScope=function(){var t=this.scopeStack.pop(),e=this.scopeStack[this.scopeStack.length-1]
at(e.childVar,t.var,t.childVar)},nt.canDeclareVarName=function(t){var e=this.scopeStack[this.scopeStack.length-1]
return!p(e.lexical,t)&&!p(e.parentLexical,t)},nt.canDeclareLexicalName=function(t){var e=this.scopeStack[this.scopeStack.length-1]
return!p(e.lexical,t)&&!p(e.var,t)&&!p(e.childVar,t)},nt.declareVarName=function(t){this.scopeStack[this.scopeStack.length-1].var[t]=!0},nt.declareLexicalName=function(t){this.scopeStack[this.scopeStack.length-1].lexical[t]=!0}
var ot=function(t,e,s){this.type="",this.start=e,this.end=0,t.options.locations&&(this.loc=new J(t,s)),t.options.directSourceFile&&(this.sourceFile=t.options.directSourceFile),t.options.ranges&&(this.range=[e,0])},ht=$.prototype
ht.startNode=function(){return new ot(this,this.start,this.startLoc)},ht.startNodeAt=function(t,e){return new ot(this,t,e)},ht.finishNode=function(t,e){return m.call(this,t,e,this.lastTokEnd,this.lastTokEndLoc)},ht.finishNodeAt=function(t,e,s,i){return m.call(this,t,e,s,i)}
var pt=function(t,e,s,i,r){this.token=t,this.isExpr=!!e,this.preserveSpace=!!s,this.override=i,this.generator=!!r},ct={b_stat:new pt("{",!1),b_expr:new pt("{",!0),b_tmpl:new pt("${",!1),p_stat:new pt("(",!1),p_expr:new pt("(",!0),q_tmpl:new pt("`",!0,!0,function(t){return t.tryReadTemplateToken()}),f_stat:new pt("function",!1),f_expr:new pt("function",!0),f_expr_gen:new pt("function",!0,!1,null,!0),f_gen:new pt("function",!1,!1,null,!0)},ut=$.prototype
ut.initialContext=function(){return[ct.b_stat]},ut.braceIsBlock=function(t){var e=this.curContext()
return e===ct.f_expr||e===ct.f_stat||(t!==O.colon||e!==ct.b_stat&&e!==ct.b_expr?t===O._return||t==O.name&&this.exprAllowed?V.test(this.input.slice(this.lastTokEnd,this.start)):t===O._else||t===O.semi||t===O.eof||t===O.parenR||t==O.arrow||(t==O.braceL?e===ct.b_stat:t!=O._var&&t!=O.name&&!this.exprAllowed):!e.isExpr)},ut.inGeneratorContext=function(){for(var t=this,e=this.context.length-1;e>=1;e--){var s=t.context[e]
...
return{done:e.type===O.eof,value:e}}}}),dt.curContext=function(){return this.context[this.context.length-1]},dt.nextToken=function(){var t=this.curContext()
return t&&t.preserveSpace||this.skipSpace(),this.start=this.pos,this.options.locations&&(this.startLoc=this.curPosition()),this.pos>=this.input.length?this.finishToken(O.eof):t.override?t.override(this):void this.readToken(this.fullCharCodeAtPos())},dt.readToken=function(t){return r(t,this.options.ecmaVersion>=6)||92===t?this.readWord():this.getTokenFromCode(t)},dt.fullCharCodeAtPos=function(){var t=this.input.charCodeAt(this.pos)
...
for(var r;(r=F.exec(this.input))&&r.index<this.pos;)++t.curLine,t.lineStart=r.index+r[0].length}this.options.onComment&&this.options.onComment(!0,this.input.slice(s+2,i),s,this.pos,e,this.curPosition())},dt.skipLineComment=function(t){for(var e=this,s=this.pos,i=this.options.onComment&&this.curPosition(),r=this.input.charCodeAt(this.pos+=t);this.pos<this.input.length&&!h(r);)r=e.input.charCodeAt(++e.pos)
this.options.onComment&&this.options.onComment(!1,this.input.slice(s+t,this.pos),s,this.pos,i,this.curPosition())},dt.skipSpace=function(){var t=this
...
return ft||(x(o,h,i,this),c=x(n,a)),this.finishToken(O.regexp,{pattern:n,flags:a,value:c})},dt.readInt=function(t,e){for(var s=this,i=this.pos,r=0,n=0,a=null==e?1/0:e;n<a;++n){var o=s.input.charCodeAt(s.pos),h=void 0
if((h=o>=97?o-97+10:o>=65?o-65+10:o>=48&&o<=57?o-48:1/0)>=t)break;++s.pos,r=r*t+h}return this.pos===i||null!=e&&this.pos-i!==e?null:r},dt.readRadixNumber=function(t){this.pos+=2
...
case 10:e+="\n"
break
default:e+=String.fromCharCode(i)}t.options.locations&&(++t.curLine,t.lineStart=t.pos),s=t.pos}else++t.pos}},dt.readInvalidTemplateToken=function(){for(var t=this;this.pos<this.input.length;this.pos++)switch(t.input[t.pos]){case"\\":++t.pos
break
case"$":if("{"!==t.input[t.pos+1])break
case"`":return t.finishToken(O.invalidTemplate,t.input.slice(t.start,t.pos))}this.raise(this.start,"Unterminated template")},dt.readEscapedChar=function(t){var e=this.input.charCodeAt(++this.pos)
...
var p=t.readCodePoint();(s?r:n)(p,a)||t.invalidStringToken(h,"Invalid Unicode escape"),e+=y(p),i=t.pos}s=!1}return e+this.input.slice(i,this.pos)},dt.readWord=function(){var t=this.readWord1(),e=O.name
return this.keywords.test(t)&&(this.containsEsc&&this.raiseRecoverable(this.start,"Escape sequence in keyword "+t),e=R[t]),this.finishToken(e,t)}
var yt,vt,gt,bt="5.2.1"},function(e,s){e.exports=t},function(t,e,s){"use strict"
