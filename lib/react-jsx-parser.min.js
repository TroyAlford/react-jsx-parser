...
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,s,i){return s&&t(e.prototype,s),i&&t(e,i),e}}(),c=s(1),u=s(5),l=i(u),d=s(6),f=i(d),m=s(8),x=i(m),y=s(9),v={plugins:{jsx:!0}},g=function(t){function e(t){r(this,e)
var s=n(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t))
return b.call(s),s.handleNewProps(t),s}return a(e,t),p(e,[{key:"componentWillReceiveProps",value:function(t){this.handleNewProps(t)}}]),e}(u.Component),b=function(){var t=this
...
return e.properties.forEach(function(e){i[e.key.name||e.key.value]=t.parseExpression(e.value)}),i
case"JSXExpressionContainer":return t.parseExpression(e.expression)
case"Literal":return e.value
default:return}},this.parseElement=function(e,s){var i=t.props,r=i.bindings,n=void 0===r?{}:r,a=i.components,p=void 0===a?{}:a,c=e.children,u=void 0===c?[]:c,d=e.openingElement,m=void 0===d?{}:d,v=m.attributes,g=void 0===v?[]:v,b=m.name
b=void 0===b?{}:b
var k=b.name,E=void 0===k?e.type:k
if(/^(html|head|body)$/i.test(E))return u.map(function(e){return t.parseElement(e)})
if(-1===t.blacklistedTags.indexOf(E.trim().toLowerCase())){var w=void 0
if(p[E]||(0,y.canHaveChildren)(E))if(w=u.map(t.parseExpression),p[E]||(0,y.canHaveWhitespace)(E)||(w=w.filter(function(t){return"string"!=typeof t||!/^\s*$/.test(t)})),0===w.length)w=void 0
else if(1===w.length){var A=w,S=h(A,1)
w=S[0]}var C=o({key:s},n)
return g.forEach(function(e){var s=e.name.name,i=x.default[s]||s,r=t.parseExpression(e)
0===t.blacklistedAttrs.filter(function(t){return t.test(i)}).length&&(C[i]=r)}),"string"==typeof C.style&&(C.style=(0,f.default)(C.style)),l.default.createElement(p[E]||E,C,w)}},this.render=function(){return t.props.renderInWrapper?l.default.createElement("div",{className:"jsx-parser"},t.ParsedChildren):t.ParsedChildren}}
e.default=g,g.defaultProps={bindings:{},blacklistedAttrs:[/^on.+/i],blacklistedTags:["script"],components:[],jsx:"",onError:function(){},showWarnings:!1,renderInWrapper:!0}},function(t,e,s){"use strict"
...
if((s+=e[i+1])>=t)return!0}}function r(t,e){return t<65?36===t:t<91||(t<97?95===t:t<123||(t<=65535?t>=170&&T.test(String.fromCharCode(t)):!1!==e&&i(t,L)))}function n(t,e){return t<48?36===t:t<58||!(t<65)&&(t<91||(t<97?95===t:t<123||(t<=65535?t>=170&&N.test(String.fromCharCode(t)):!1!==e&&(i(t,L)||i(t,P)))))}function a(t,e){return new j(t,{beforeExpr:!0,binop:e})}function o(t,e){return void 0===e&&(e={}),e.keyword=t,O[t]=new j(t,e)}function h(t){return 10===t||13===t||8232===t||8233===t}function p(t,e){return X.call(t,e)}function c(t,e){for(var s=1,i=0;;){D.lastIndex=i
var r=D.exec(t)
...
default:if(!(e>8&&e<14||e>=5760&&M.test(String.fromCharCode(e))))break t;++t.pos}}},ft.finishToken=function(t,e){this.end=this.pos,this.options.locations&&(this.endLoc=this.curPosition())
var s=this.type
