...
0===t.blacklistedAttrs.filter(function(t){return t.test(i)}).length&&(A[i]=r)}),"string"==typeof A.style&&(A.style=(0,f.default)(A.style)),l.default.createElement(a[b]||b,A,k)}},this.render=function(){return t.props.renderInWrapper?l.default.createElement("div",{className:"jsx-parser"},t.ParsedChildren):t.ParsedChildren}}
